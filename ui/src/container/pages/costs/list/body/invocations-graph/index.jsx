...
function InvocationsGraph({ routeName }) {
  const { data, isError, isLoading, isSuccess } = useGetInvocationsForChartsByRouteNameWithRange({ routeName });
...
function IsSuccess({ routeName }) {
  ...
  const { data } = useGetInvocationsForChartsByRouteNameWithRange({ routeName });
...
const usePollingGetRouteInvocations = (routeName) => {
  ...
  const { isError } = useGetInvocationsForChartsByRouteNameWithRange({ routeName }, { pollingInterval });
