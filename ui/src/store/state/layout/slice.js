...
export const layoutSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(layoutActions.hideRightColumn, (state) => ({ ...state, hasRightColumn: false }));
    ...
    builder.addCase(layoutActions.lightenRightColumn, (state) => ({ ...state, hasRightContentDark: false }));
